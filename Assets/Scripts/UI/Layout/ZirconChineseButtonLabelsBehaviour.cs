...
{
    /// <summary>
    /// Keeps fixed and state-dependent mobile button labels in Simplified Chinese.
    /// The periodic refresh also covers labels changed later by panel controllers.
    /// </summary>
    public sealed class ZirconChineseButtonLabelsBehaviour : MonoBehaviour
    {
